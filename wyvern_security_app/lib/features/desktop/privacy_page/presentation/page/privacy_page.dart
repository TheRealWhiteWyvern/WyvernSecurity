...
class DesktopPrivacyPage extends StatefulWidget {
  const DesktopPrivacyPage({super.key});

  @override
  DesktopPrivacyPageState createState() => DesktopPrivacyPageState();
}

class DesktopPrivacyPageState extends State<DesktopPrivacyPage> {
